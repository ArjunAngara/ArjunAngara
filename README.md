...
Algorithmic trading bot generating buy signals when 50-day MA crosses 200-day MA with backtesting and P&L output.

### Portfolio P&L Tracker
Tracks trades and calculates profit/loss, Sharpe Ratio, and risk metrics.

### Sentiment Analyzer
Scans financial news headlines using NLP to generate sentiment scores for individual stocks.

### Monte Carlo Simulator
Runs 1,000+ simulations of future stock prices based on historical volatility for options pricing foundations.
